...
# python3 analyze_primer_search.py -list /path/to/list_of_tsvs -reference /path/to/ref.fsa -mismatch 3 -output_file /path/to/out_matrix.tsv
#
...
def main():
    ...
    with open(args.output_file,'w') as out:
        ...
        for id in order:
            out.write("{0}\t{1}\n".format(id,("\t").join(map(str,valid_pair_dict[id]))))
